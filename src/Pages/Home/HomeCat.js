            ...
            <div className="2xl:mx-auto 2xl:container py-12 px-4 sm:px-6 xl:px-20 2xl:px-0 w-full">
                <div className="flex flex-col jusitfy-center items-center space-y-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 md:gap-x-4 md:gap-x-8 w-full">
                    {
                        ...
                        <div className={`${
				index === 0 &&
				'relative group justify-center items-center h-full w-full'
			} ${
				index === 3 &&
				'relative group justify-center items-center h-full w-full hidden lg:flex'
			}`
                        }>
                            <img className="object-center object-cover h-full w-full" src={category.img} alt="girl" />
                            <button className="dark:bg-gray-800 dark:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-400 bottom-4 z-10 absolute text-base font-medium leading-none text-gray-800 py-3 w-36 bg-white">{category.name}</button>
